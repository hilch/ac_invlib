...
acpienumeration en_P74_AIOL[] = {
	{	"POS"		,	    0	},	/* [0 - 100%]  */
	{	"nEG"		,	    1	},	/* [+/- 100%]  */
	{ 0,  0 }
};

acpienumeration en_P74_AIOT[] = {
	{	"10U"		,	    1	},	/* [Voltage]  */
	{	"0A"		,	    2	},	/* [Current]  */
	{	"n10U"		,	    5	},	/* [Voltage +/-]  */
	{ 0,  0 }
...
acpienumeration en_P74_BFR[] = {
	{	"50"		,	    0	},	/* [50Hz IEC]  */
	{	"60"		,	    1	},	/* [60Hz NEMA]  */
	{ 0,  0 }
};

acpienumeration en_P74_BIP[] = {
	{	"nO"		,	    0	},	/* [No]  */
	{	"YES"		,	    1	},	/* [Yes]  */
	{	"2Ibr"		,	    2	},	/* [2 IBR]  */
	{ 0,  0 }
...
acpienumeration en_P74_BMP[] = {
	{	"StOP"		,	    0	},	/* [Stop]  */
	{	"bUMP"		,	    1	},	/* [Bumpless]  */
	{ 0,  0 }
};

acpienumeration en_P74_BOA[] = {
	{	"nO"		,	    0	},	/* [Inactive]  */
	{	"dYnA"		,	    1	},	/* [Dynamic]  */
	{	"StAt"		,	    2	},	/* [Static]  */
	{ 0,  0 }
...
acpienumeration en_P74_BST[] = {
	{	"HOr"		,	    0	},	/* [Traveling]  */
	{	"UEr"		,	    1	},	/* [Hoisting]  */
	{ 0,  0 }
};

acpienumeration en_P74_CDX[] = {
	{	"tEr"		,	    1	},	/* [Terminals]  */
	{	"LOC"		,	    2	},	/* [Local]  */
	{	"LCC"		,	    3	},	/* [HMI]  */
	{	"Mdb"		,	   10	},	/* [Modbus]  */
...
acpienumeration en_P74_DOTD[] = {
	{	"nSt"		,	    0	},	/* [Freewheel]  */
	{	"rMP"		,	    1	},	/* [Ramp stop]  */
	{ 0,  0 }
};

acpienumeration en_P74_DPMA[] = {
	{	"1"		,	    1	},	/* [MCL1]  */
	{	"2"		,	    2	},	/* [MCL2]  */
	{ 0,  0 }
};

acpienumeration en_P74_DSF[] = {
	{	"Std"		,	    0	},	/* [Standard]  */
	{	"OPt"		,	    1	},	/* [Optimized]  */
	{ 0,  0 }
};

acpienumeration en_P74_DUR[] = {
	{	"5"		,	    0	},	/* [5 minutes]  */
	{	"10"		,	    1	},	/* [10 minutes]  */
	{	"30"		,	    2	},	/* [30 minutes]  */
	{	"1H"		,	    3	},	/* [1 hour]  */
...
acpienumeration en_P74_ETHM[] = {
	{	"MbtP"		,	    0	},	/* [ModbusTCP]  */
	{	"EtIP"		,	    1	},	/* [EthernetIP]  */
	{ 0,  0 }
};

acpienumeration en_P74_FBFT[] = {
	{	"nO"		,	    0	},	/* [No]  */
	{	"Int"		,	    1	},	/* [Internal]  */
	{	"bIn"		,	    2	},	/* [Binary file]  */
	{	"InP"		,	    3	},	/* [Intern para.]  */
...
acpienumeration en_P74_L_H[] = {
	{	"LO"		,	    0	},	/* [Active low]  */
	{	"HIG"		,	    1	},	/* [Active high]  */
	{ 0,  0 }
};

acpienumeration en_P74_LFT[] = {
	{	"nOF"		,	    0	},	/* [No fault]  */
...
acpienumeration en_P74_N_Y[] = {
	{	"nO"		,	    0	},	/* [No]  */
	{	"YES"		,	    1	},	/* [Yes]  */
	{ 0,  0 }
};

acpienumeration en_P74_NCV[] = {
	{	"nO"		,	    0	},	/* [Unknown rating]  */
	{	"010"		,	    1	},	/* [0,12kW]  */
	{	"018"		,	    2	},	/* [0,18kW / 0.25HP]  */
	{	"025"		,	    3	},	/* [0,25kW]  */
...
acpienumeration en_P74_NPL[] = {
	{	"POS"		,	    0	},	/* [1]  */
	{	"nEG"		,	    1	},	/* [0]  */
	{ 0,  0 }
};

acpienumeration en_P74_ONOFF[] = {
	{	"OFF"		,	    0	},	/* [OFF]  */
	{	"On"		,	    1	},	/* [ON]  */
	{ 0,  0 }
};

acpienumeration en_P74_OPL[] = {
	{	"nO"		,	    0	},	/* [No]  */
	{	"YES"		,	    1	},	/* [Yes]  */
	{	"OAC"		,	    2	},	/* [Output cut]  */
	{ 0,  0 }
...
acpienumeration en_P74_QSTD[] = {
	{	"FSt2"		,	    2	},	/*   */
	{	"FSt6"		,	    6	},	/*   */
	{ 0,  0 }
};

acpienumeration en_P74_RDS[] = {
	{	"AUtO"		,	    0	},	/* [Auto]  */
	{	"10F"		,	    1	},	/* [10M. full]  */
	{	"10H"		,	    2	},	/* [10M. half]  */
	{	"100F"		,	    3	},	/* [100M. full]  */
...
acpienumeration en_P74_SFT[] = {
	{	"HF1"		,	    1	},	/* [SFR type 1]  */
	{	"HF2"		,	    2	},	/* [SFR type 2]  */
	{ 0,  0 }
};

acpienumeration en_P74_SFTY[] = {
	{	"Std"		,	    0	},	/* [Standard]  */
	{	"SAFE"		,	    1	},	/* [Safe]  */
	{ 0,  0 }
};

acpienumeration en_P74_SLSS[] = {
	{	"nO"		,	    0	},	/* [Not config.]  */
	{	"IdLE"		,	    1	},	/* [Idle]  */
	{	"SS1"		,	    2	},	/* [Safe ramp]  */
	{	"SLS"		,	    3	},	/* [Spd limited]  */
...
acpienumeration en_P74_SPIG[] = {
	{	"StOP"		,	    0	},	/* [Stop]  */
	{	"IGn"		,	    1	},	/* [Ignore]  */
	{ 0,  0 }
};

acpienumeration en_P74_SPSL[] = {
	{	"nO"		,	    0	},	/*   */
	{	"L34"		,	    1	},	/*   */
	{	"L56"		,	    2	},	/*   */
	{	"L3PW"		,	    3	},	/*   */
...
acpienumeration en_P74_SPST[] = {
	{	"StOP"		,	    0	},	/* [Stop]  */
	{	"Strt"		,	    1	},	/* [Start]  */
	{ 0,  0 }
};

acpienumeration en_P74_SS1S[] = {
	{	"nO"		,	    0	},	/* [Not config.]  */
	{	"IdLE"		,	    1	},	/* [Idle]  */
	{	"SS1"		,	    2	},	/* [Safe ramp]  */
	{	"StO"		,	    3	},	/* [Safe stop]  */
...
acpienumeration en_P74_TCC[] = {
	{	"2C"		,	    0	},	/* [2 wire]  */
	{	"3C"		,	    1	},	/* [3 wire]  */
	{ 0,  0 }
};

acpienumeration en_P74_TCT[] = {
	{	"LEL"		,	    0	},	/* [Level]  */
	{	"trn"		,	    1	},	/* [Transition]  */
	{	"PFO"		,	    2	},	/* [Fwd priority]  */
	{ 0,  0 }
